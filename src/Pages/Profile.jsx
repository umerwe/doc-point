...
const Profile = () => {
  ...
  const profileDataFromRedux = useSelector((store) => store.userSlice.profileData);
  ...
  // Update local state on file selection
  ...
  // Save changes to Firestore when clicking Save Information
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-lg flex flex-col gap-2 text-sm pt-5">
        ...
        <p className="font-medium text-3xl text-[#262626] mt-4 text-center">
          {user.displayName}
        </p>
        ...
        <div className="w-full px-4">
          <p className="text-gray-600 underline mt-3 text-center">CONTACT INFORMATION</p>
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]">
            ...
            {isEditing ? (
              <textarea
                ...
                onChange={handleChange}
                className="bg-gray-50 w-full h-24 max-[515px]:h-20 border-2 rounded-md px-3 py-1 resize-none text-[13px]"
        ...
        {/* BASIC INFORMATION */}
        <div className="w-full px-4">
          <p className="text-[#797979] underline mt-3 text-center">BASIC INFORMATION</p>
